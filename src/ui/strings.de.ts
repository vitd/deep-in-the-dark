...
export const STR = {
  ...
  falleTreffer: (name: string, dmg: number) => `${name}! -${dmg} Leben`,
  fallenNamen: {
    stacheln: 'Stachelfalle',
    axt: 'Pendelaxt',
    harpune: 'Harpunenfalle',
    fallbeil: 'Fallbeil',
  } as Record<string, string>,
  fallenTodTitel: 'DIE FALLEN DES TIEFENTEMPELS',
  luftblase: 'Luftblase – durchatmen',
